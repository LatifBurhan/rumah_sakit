        ...
        <form method="POST" action="{{ route('update', $form->id) }}">
            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-lg font-semibold text-gray-900 text-center">FORM EDIT</h2>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" name="name" id="username"
                                    ...
                                    placeholder="Nama" value="{{ old('name', $form->name) }}">
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="mt-2 relative">
                                ...
                                <input id="pendapatan" name="pendapatan" type="text"
                                    ...
                                    value="{{ old('pendapatan', number_format($form->pendapatan, 0, ',', '.')) }}">
                            </div>
                            @error('pendapatan')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                                ...
                                <select id="provinsi" name="provinsi_id"
                                    ...
                                    @foreach ($provinsi as $prov)
                                        <option value="{{ $prov->id }}"
                                            {{ old('provinsi_id', $form->provinsi_id) == $prov->id ? 'selected' : '' }}>
                                            {{ $prov->nama_provinsi }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="kota" name="kota_id"
                                    ...
                                    @foreach ($kotas as $kota)
                                        <option value="{{ $kota->id }}"
                                            {{ old('kota_id', $form->kota_id) == $kota->id ? 'selected' : '' }}>
                                            {{ $kota->nama_kota }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" name="alamat" id="street-address" autocomplete="street-address"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:outline-indigo-600 sm:text-sm"
                                    placeholder="Masukkan alamat lengkap" value="{{ old('alamat', $form->alamat) }}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-6 space-y-3">
                                <div>
                                    ...
                                    <input id="alergi-obat" name="alergi[]" value="obat" type="checkbox"
                                        ...
                                        {{ in_array('obat', old('alergi', explode(',', $form->alergi ?? ''))) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input id="alergi-makanan" name="alergi[]" value="makana" type="checkbox"
                                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        {{ in_array('makana', old('alergi', explode(',', $form->alergi ?? ''))) ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input id="alergi-debu" name="alergi[]" value="debu" type="checkbox"
                                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        {{ in_array('debu', old('alergi', explode(',', $form->alergi ?? ''))) ? 'checked' : '' }}>
                            ...
                            <div class="mt-6 space-y-3">
                                <div>
                                    <input id="gol-darah-o" name="golongan_darah" value="o" type="radio"
                                        ...
                                        {{ old('golongan_darah', $form->golongan_darah) == 'o' ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input id="gol-darah-a" name="golongan_darah" value="a" type="radio"
                                        class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        {{ old('golongan_darah', $form->golongan_darah) == 'a' ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input id="gol-darah-b" name="golongan_darah" value="b" type="radio"
                                        class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        {{ old('golongan_darah', $form->golongan_darah) == 'b' ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input id="gol-darah-ab" name="golongan_darah" value="ab" type="radio"
                                        class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        {{ old('golongan_darah', $form->golongan_darah) == 'ab' ? 'checked' : '' }}>
